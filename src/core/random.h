...
pcg32_random_t randomSeed(u64 initialState, u64 initialSequence){
    pcg32_random_t temp;
...
i32 randomInt(pcg32_random_t* rng_state,i32 min, i32 max){
    return min + pcg32_boundedrand_r(rng_state, max - min + 1);
}

f32 randomFloat(pcg32_random_t* rng_state){
